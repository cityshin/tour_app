...
class _MapPage extends State<MapPage> {
  ...
  String authKey = 'MAXJqfOP76T3P6K6%2B7TSY9DZOEHwz7CmMIQEg04i9RAbHqp2lEXCv7nbr11BQ7bf6Kw8Fjo13EKPoyfI86wSzA%3D%3D';
...
// 시작
                                  ...
                                  child: Column(
                                    children: <Widget>[
                                      ...
                                      tourData[index].tel !=null?
                                          Text('전화번호: ${tourData[index].tel}') : Container(),
                                    ],
  ...
  void insertTour(Future<Database> db, TourData info) async {
    ...
    await database.insert('place', info.toMap(),conflictAlgorithm: ConflictAlgorithm.replace).then((value){
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('즐겨찾기 추가 완료')));
    });
  }
}